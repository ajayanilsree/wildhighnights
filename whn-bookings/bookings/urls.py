...
urlpatterns = [
    ...
    path('dashboard/accounts/', views.admin_accounts_selection_view, name='admin_accounts'),
    path('dashboard/accounts/artists/', views.admin_artist_accounts_view, name='admin_artist_accounts'),
    path('dashboard/accounts/whn/', views.admin_whn_accounts_view, name='admin_whn_accounts'),
